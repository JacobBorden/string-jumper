...
call fzf#run({'source': 'echo '. string(result), 'options': '--preview' .function(Callback(result)),  'sink': function('SinkFunction'), 'preview-window': 'wrap'})
